...
const translations: Translations = {
  en: {
    ...
    // Price page
    "price.title": "Pricing",
    "price.subtitle": "Elevate Your Online Presence: Competitive Pricing for Exceptional Results",
    "price.basic": "Basic Plan",
    "price.pro": "Pro Plan",
    "price.elite": "Elite Plan",
    "price.month": "/month",
  ...
  uk: {
    ...
    // Price page
    "price.title": "Ціни",
    "price.subtitle": "Підвищіть свою онлайн-присутність: конкурентні ціни для виняткових результатів",
    "price.basic": "Базовий план",
    "price.pro": "Професійний план",
    "price.elite": "Елітний план",
    "price.month": "/місяць",
