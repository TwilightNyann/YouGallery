...
export default function SettingsPage() {
  ...
  const confirmDeleteGallery = async () => {
    ...
    try {
      console.log(`Attempting to delete gallery with ID: ${galleryIdToDelete}`)
      await apiClient.deleteGallery(galleryIdToDelete)
    ...
    <main className="min-h-screen flex flex-col">
      ...
      <Dialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <DialogContent>
          ...
          <DialogFooter>
            <Button variant="outline" onClick={cancelDeleteGallery} disabled={deleteGalleryLoading}>
              {t("profile.cancel")}
            </Button>
            <Button variant="destructive" onClick={confirmDeleteGallery} disabled={deleteGalleryLoading}>
              {deleteGalleryLoading ? t("profile.deleting") : t("profile.deleteButtonConfirm")}
            </Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
